...
@RequestMapping("base/boot/managerAccount")
public class ManagerAccountController extends FeignMethodController<ManagerAccountDto, ManagerAccountFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerAccountController.class);
