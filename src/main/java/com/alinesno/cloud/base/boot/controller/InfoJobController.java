...
import com.alinesno.cloud.base.boot.feign.dto.InfoJobDto ;
import com.alinesno.cloud.base.boot.feign.facade.InfoJobFeigin ;
...
@RequestMapping("base/boot/infoJob")
public class InfoJobController extends FeignMethodController<InfoJobDto, InfoJobFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(InfoJobController.class);
