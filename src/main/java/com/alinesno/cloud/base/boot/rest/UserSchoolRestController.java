...
public class UserSchoolRestController extends BaseRestController<UserSchoolEntity , IUserSchoolService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserSchoolRestController.class);
