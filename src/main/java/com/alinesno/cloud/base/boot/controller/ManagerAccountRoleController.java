...
import com.alinesno.cloud.base.boot.feign.dto.ManagerAccountRoleDto ;
import com.alinesno.cloud.base.boot.feign.facade.ManagerAccountRoleFeigin ;
...
@RequestMapping("base/boot/managerAccountRole")
public class ManagerAccountRoleController extends FeignMethodController<ManagerAccountRoleDto, ManagerAccountRoleFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerAccountRoleController.class);
