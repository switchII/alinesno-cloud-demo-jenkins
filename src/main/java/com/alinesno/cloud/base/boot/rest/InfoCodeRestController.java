...
@RestController
@RequestMapping("infoCode")
public class InfoCodeRestController extends BaseRestController<InfoCodeEntity , IInfoCodeService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(InfoCodeRestController.class);
