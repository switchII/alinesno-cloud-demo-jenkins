...
import com.alinesno.cloud.base.boot.feign.dto.UserJobDto ;
import com.alinesno.cloud.base.boot.feign.facade.UserJobFeigin ;
...
@RequestMapping("base/boot/userJob")
public class UserJobController extends FeignMethodController<UserJobDto, UserJobFeigin> {
