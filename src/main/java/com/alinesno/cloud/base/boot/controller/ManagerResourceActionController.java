...
import com.alinesno.cloud.base.boot.feign.dto.ManagerResourceActionDto ;
import com.alinesno.cloud.base.boot.feign.facade.ManagerResourceActionFeigin ;
...
@RequestMapping("base/boot/managerResourceAction")
public class ManagerResourceActionController extends FeignMethodController<ManagerResourceActionDto, ManagerResourceActionFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerResourceActionController.class);
