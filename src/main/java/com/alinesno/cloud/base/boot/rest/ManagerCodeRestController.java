...
public class ManagerCodeRestController extends BaseRestController<ManagerCodeEntity , IManagerCodeService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(ManagerCodeRestController.class);
