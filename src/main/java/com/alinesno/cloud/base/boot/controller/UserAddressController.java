...
import com.alinesno.cloud.base.boot.feign.facade.UserAddressFeigin ;
...
@RequestMapping("base/boot/userAddress")
public class UserAddressController extends FeignMethodController<UserAddressDto, UserAddressFeigin> {
