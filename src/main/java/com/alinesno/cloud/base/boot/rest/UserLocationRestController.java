...
public class UserLocationRestController extends BaseRestController<UserLocationEntity , IUserLocationService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserLocationRestController.class);
