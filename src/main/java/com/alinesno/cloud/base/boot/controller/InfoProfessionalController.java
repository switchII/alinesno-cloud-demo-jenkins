...
import com.alinesno.cloud.base.boot.feign.dto.InfoProfessionalDto ;
import com.alinesno.cloud.base.boot.feign.facade.InfoProfessionalFeigin ;
...
@RequestMapping("base/boot/infoProfessional")
public class InfoProfessionalController extends FeignMethodController<InfoProfessionalDto, InfoProfessionalFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(InfoProfessionalController.class);
