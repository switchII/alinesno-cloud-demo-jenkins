...
@RestController
@RequestMapping("infoSchool")
public class InfoSchoolRestController extends BaseRestController<InfoSchoolEntity , IInfoSchoolService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(InfoSchoolRestController.class);
