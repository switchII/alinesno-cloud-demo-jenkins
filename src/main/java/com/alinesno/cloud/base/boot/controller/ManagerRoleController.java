...
@RequestMapping("base/boot/managerRole")
public class ManagerRoleController extends FeignMethodController<ManagerRoleDto, ManagerRoleFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerRoleController.class);
