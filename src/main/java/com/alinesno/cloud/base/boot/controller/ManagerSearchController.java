...
import com.alinesno.cloud.base.boot.feign.dto.ManagerSearchDto ;
import com.alinesno.cloud.base.boot.feign.facade.ManagerSearchFeigin ;
...
@RequestMapping("base/boot/managerSearch")
public class ManagerSearchController extends FeignMethodController<ManagerSearchDto, ManagerSearchFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerSearchController.class);
