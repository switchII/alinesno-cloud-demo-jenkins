...
@RequestMapping("base/boot/managerCodeType")
public class ManagerCodeTypeController extends FeignMethodController<ManagerCodeTypeDto, ManagerCodeTypeFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerCodeTypeController.class);
