...
public class ManagerTemplateRestController extends BaseRestController<ManagerTemplateEntity , IManagerTemplateService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(ManagerTemplateRestController.class);
