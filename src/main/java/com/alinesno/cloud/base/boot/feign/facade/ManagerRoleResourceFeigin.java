 ...
 */
@FeignClient(name="alinesno-cloud-base-boot" , path="managerRoleResource")
public interface ManagerRoleResourceFeigin extends IBaseFeign<ManagerRoleResourceDto> {
