...
public class ContentLinksRestController extends BaseRestController<ContentLinksEntity , IContentLinksService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(ContentLinksRestController.class);
