...
import com.alinesno.cloud.base.boot.feign.dto.UserProfessionalDto ;
import com.alinesno.cloud.base.boot.feign.facade.UserProfessionalFeigin ;
...
@RequestMapping("base/boot/userProfessional")
public class UserProfessionalController extends FeignMethodController<UserProfessionalDto, UserProfessionalFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(UserProfessionalController.class);
