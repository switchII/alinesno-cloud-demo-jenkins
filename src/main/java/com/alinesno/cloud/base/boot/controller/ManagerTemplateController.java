...
import com.alinesno.cloud.base.boot.feign.dto.ManagerTemplateDto ;
import com.alinesno.cloud.base.boot.feign.facade.ManagerTemplateFeigin ;
...
@RequestMapping("base/boot/managerTemplate")
public class ManagerTemplateController extends FeignMethodController<ManagerTemplateDto, ManagerTemplateFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerTemplateController.class);
