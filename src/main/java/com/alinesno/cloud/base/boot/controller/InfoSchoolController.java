...
import com.alinesno.cloud.base.boot.feign.dto.InfoSchoolDto ;
import com.alinesno.cloud.base.boot.feign.facade.InfoSchoolFeigin ;
...
@RequestMapping("base/boot/infoSchool")
public class InfoSchoolController extends FeignMethodController<InfoSchoolDto, InfoSchoolFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(InfoSchoolController.class);
