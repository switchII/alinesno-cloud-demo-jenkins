...
@RequestMapping("base/boot/managerSourceGenerate")
public class ManagerSourceGenerateController extends FeignMethodController<ManagerSourceGenerateDto, ManagerSourceGenerateFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerSourceGenerateController.class);
