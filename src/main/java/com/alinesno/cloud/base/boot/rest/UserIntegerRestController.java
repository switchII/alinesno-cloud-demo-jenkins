...
@RestController
@RequestMapping("userInteger")
public class UserIntegerRestController extends BaseRestController<UserIntegerEntity , IUserIntegerService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserIntegerRestController.class);
