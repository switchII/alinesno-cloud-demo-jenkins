...
@RequestMapping("base/boot/managerAccountRecord")
public class ManagerAccountRecordController extends FeignMethodController<ManagerAccountRecordDto, ManagerAccountRecordFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerAccountRecordController.class);
