...
public class UserClassesRestController extends BaseRestController<UserClassesEntity , IUserClassesService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserClassesRestController.class);
