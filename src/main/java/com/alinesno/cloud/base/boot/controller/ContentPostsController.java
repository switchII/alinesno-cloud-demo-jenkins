...
@RequestMapping("base/boot/contentPosts")
public class ContentPostsController extends FeignMethodController<ContentPostsDto, ContentPostsFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ContentPostsController.class);
