...
import com.alinesno.cloud.base.boot.feign.facade.UserIntegerFeigin ;
...
@RequestMapping("base/boot/userInteger")
public class UserIntegerController extends FeignMethodController<UserIntegerDto, UserIntegerFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(UserIntegerController.class);
