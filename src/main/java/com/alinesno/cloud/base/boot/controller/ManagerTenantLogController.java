...
import com.alinesno.cloud.base.boot.feign.dto.ManagerTenantLogDto ;
import com.alinesno.cloud.base.boot.feign.facade.ManagerTenantLogFeigin ;
...
@RequestMapping("base/boot/managerTenantLog")
public class ManagerTenantLogController extends FeignMethodController<ManagerTenantLogDto, ManagerTenantLogFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerTenantLogController.class);
