...
import com.alinesno.cloud.base.boot.feign.dto.ContentPostmetaDto ;
import com.alinesno.cloud.base.boot.feign.facade.ContentPostmetaFeigin ;
...
@RequestMapping("base/boot/contentPostmeta")
public class ContentPostmetaController extends FeignMethodController<ContentPostmetaDto, ContentPostmetaFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ContentPostmetaController.class);
