...
@RestController
@RequestMapping("managerTenant")
public class ManagerTenantRestController extends BaseRestController<ManagerTenantEntity , IManagerTenantService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(ManagerTenantRestController.class);
