...
import com.alinesno.cloud.base.boot.feign.facade.UserAccountFeigin ;
...
@RequestMapping("base/boot/userAccount")
public class UserAccountController extends FeignMethodController<UserAccountDto, UserAccountFeigin> {
