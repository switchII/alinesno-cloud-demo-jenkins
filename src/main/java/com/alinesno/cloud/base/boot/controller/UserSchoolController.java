...
import com.alinesno.cloud.base.boot.feign.facade.UserSchoolFeigin ;
...
@RequestMapping("base/boot/userSchool")
public class UserSchoolController extends FeignMethodController<UserSchoolDto, UserSchoolFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(UserSchoolController.class);
