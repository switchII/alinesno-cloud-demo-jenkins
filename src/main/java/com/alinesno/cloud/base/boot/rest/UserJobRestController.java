...
public class UserJobRestController extends BaseRestController<UserJobEntity , IUserJobService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserJobRestController.class);
