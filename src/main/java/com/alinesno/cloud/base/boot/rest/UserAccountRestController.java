...
public class UserAccountRestController extends BaseRestController<UserAccountEntity , IUserAccountService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserAccountRestController.class);
