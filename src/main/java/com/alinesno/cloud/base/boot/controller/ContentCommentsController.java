...
import com.alinesno.cloud.base.boot.feign.dto.ContentCommentsDto ;
import com.alinesno.cloud.base.boot.feign.facade.ContentCommentsFeigin ;
...
@RequestMapping("base/boot/contentComments")
public class ContentCommentsController extends FeignMethodController<ContentCommentsDto, ContentCommentsFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ContentCommentsController.class);
