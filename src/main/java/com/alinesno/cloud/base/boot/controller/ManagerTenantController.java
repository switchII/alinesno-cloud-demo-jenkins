...
import com.alinesno.cloud.base.boot.feign.dto.ManagerTenantDto ;
import com.alinesno.cloud.base.boot.feign.facade.ManagerTenantFeigin ;
...
@RequestMapping("base/boot/managerTenant")
public class ManagerTenantController extends FeignMethodController<ManagerTenantDto, ManagerTenantFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerTenantController.class);
