...
import com.alinesno.cloud.base.boot.feign.facade.UserClassesFeigin ;
...
@RequestMapping("base/boot/userClasses")
public class UserClassesController extends FeignMethodController<UserClassesDto, UserClassesFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(UserClassesController.class);
