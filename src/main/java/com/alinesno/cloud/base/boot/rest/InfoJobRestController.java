...
@RestController
@RequestMapping("infoJob")
public class InfoJobRestController extends BaseRestController<InfoJobEntity , IInfoJobService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(InfoJobRestController.class);
