...
import com.alinesno.cloud.base.boot.feign.dto.UserPicDto ;
import com.alinesno.cloud.base.boot.feign.facade.UserPicFeigin ;
...
@RequestMapping("base/boot/userPic")
public class UserPicController extends FeignMethodController<UserPicDto, UserPicFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(UserPicController.class);
