...
import com.alinesno.cloud.base.boot.feign.dto.InfoSettingsDto ;
import com.alinesno.cloud.base.boot.feign.facade.InfoSettingsFeigin ;
...
@RequestMapping("base/boot/infoSettings")
public class InfoSettingsController extends FeignMethodController<InfoSettingsDto, InfoSettingsFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(InfoSettingsController.class);
