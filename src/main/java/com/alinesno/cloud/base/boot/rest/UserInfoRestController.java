...
public class UserInfoRestController extends BaseRestController<UserInfoEntity , IUserInfoService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserInfoRestController.class);
