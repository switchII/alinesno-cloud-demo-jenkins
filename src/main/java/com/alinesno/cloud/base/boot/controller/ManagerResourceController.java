...
@RequestMapping("base/boot/managerResource")
public class ManagerResourceController extends FeignMethodController<ManagerResourceDto, ManagerResourceFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerResourceController.class);
