...
public class UserAddressRestController extends BaseRestController<UserAddressEntity , IUserAddressService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(UserAddressRestController.class);
