...
@RequestMapping("base/boot/managerDepartment")
public class ManagerDepartmentController extends FeignMethodController<ManagerDepartmentDto, ManagerDepartmentFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerDepartmentController.class);
