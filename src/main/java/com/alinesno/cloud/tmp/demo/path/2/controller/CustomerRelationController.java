...
import com.alinesno.cloud.tmp.demo.path.2.feign.dto.CustomerRelationDto ;
import com.alinesno.cloud.tmp.demo.path.2.feign.facade.CustomerRelationFeigin ;
...
@RequestMapping("tmp/demo/path/2/customerRelation")
