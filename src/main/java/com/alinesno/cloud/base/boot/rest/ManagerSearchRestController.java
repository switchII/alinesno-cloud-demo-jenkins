...
public class ManagerSearchRestController extends BaseRestController<ManagerSearchEntity , IManagerSearchService> {

	//日志记录
	@SuppressWarnings("unused")
	private final static Logger log = LoggerFactory.getLogger(ManagerSearchRestController.class);
