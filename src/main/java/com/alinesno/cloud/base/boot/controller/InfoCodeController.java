...
import com.alinesno.cloud.base.boot.feign.dto.InfoCodeDto ;
import com.alinesno.cloud.base.boot.feign.facade.InfoCodeFeigin ;
...
@RequestMapping("base/boot/infoCode")
public class InfoCodeController extends FeignMethodController<InfoCodeDto, InfoCodeFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(InfoCodeController.class);
