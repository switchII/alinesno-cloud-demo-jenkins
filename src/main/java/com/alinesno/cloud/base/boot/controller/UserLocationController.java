...
import com.alinesno.cloud.base.boot.feign.dto.UserLocationDto ;
import com.alinesno.cloud.base.boot.feign.facade.UserLocationFeigin ;
...
@RequestMapping("base/boot/userLocation")
public class UserLocationController extends FeignMethodController<UserLocationDto, UserLocationFeigin> {
