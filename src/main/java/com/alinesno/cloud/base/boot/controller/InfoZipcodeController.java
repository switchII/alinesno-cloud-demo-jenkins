...
import com.alinesno.cloud.base.boot.feign.facade.InfoZipcodeFeigin ;
...
@RequestMapping("base/boot/infoZipcode")
public class InfoZipcodeController extends FeignMethodController<InfoZipcodeDto, InfoZipcodeFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(InfoZipcodeController.class);
