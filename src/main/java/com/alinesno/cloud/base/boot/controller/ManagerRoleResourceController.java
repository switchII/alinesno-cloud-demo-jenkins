...
@RequestMapping("base/boot/managerRoleResource")
public class ManagerRoleResourceController extends FeignMethodController<ManagerRoleResourceDto, ManagerRoleResourceFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerRoleResourceController.class);
