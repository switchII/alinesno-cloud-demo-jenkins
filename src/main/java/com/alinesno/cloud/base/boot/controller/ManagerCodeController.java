...
@RequestMapping("base/boot/managerCode")
public class ManagerCodeController extends FeignMethodController<ManagerCodeDto, ManagerCodeFeigin> {

	//日志记录
	private static final Logger log = LoggerFactory.getLogger(ManagerCodeController.class);
